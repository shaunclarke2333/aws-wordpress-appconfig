...
wp core install --url="wordpress.shaunsawslab.link" --title="Shauns terraform automated deployment" --admin_user="shaun" --admin_password="Nothin23" --admin_email="shaunclarke43@gmail.com" --allow-root
