...
wp core install --url="domain_name_here" --title="Shauns terraform automated deployment" --admin_user=$adminname --admin_password=$adminpassword --admin_email="shaunclarke43@gmail.com" --allow-root
